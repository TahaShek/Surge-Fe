      ...
      >
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* ✅ Resume File Upload */}
            <div>
              <label className="block text-sm font-semibold mb-1 dark:text-white text-gray-800 flex items-center gap-2">
                <FileUp className="w-4 h-4 text-gray-600 dark:text-white" />
                Resume (PDF or DOC)
              </label>
              <input
                type="file"
